...
// Using parameter values directly for resource names (simpler than referencing nested symbolic names)
output cosmosGremlinDatabaseName string = cosmosGremlinDatabaseName
output cosmosGremlinGraphName string = cosmosGremlinGraphName
output cosmosSqlDatabaseName string = cosmosSqlDatabaseName
output cosmosSqlPlayersContainerName string = cosmosSqlPlayersContainerName
output cosmosSqlInventoryContainerName string = cosmosSqlInventoryContainerName
output cosmosSqlLayersContainerName string = cosmosSqlLayersContainerName
output cosmosSqlEventsContainerName string = cosmosSqlEventsContainerName
