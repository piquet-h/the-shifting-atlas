...
>
> **Authoritative Reference:** For complete current normalization invariants (ambiguous handling, typo tolerance, relative direction resolution), see `../concept/direction-resolution-rules.md` (relocated). This section describes the aspirational roadmap for future enhancements.
