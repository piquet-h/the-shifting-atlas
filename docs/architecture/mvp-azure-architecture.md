...
- **Player:** State in SQL API (`currentLocationId`). (Post ADR-004: no Gremlin player vertices.)
...
- Direction normalization & movement telemetry (`Navigation.Move.Success` / `Navigation.Move.Blocked`)
