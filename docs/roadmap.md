...
| M7 Post-MVP Extensibility | Multiplayer, quests, economy, AI write path   | Multiplayer synchronization & party state, Quest & dialogue branching, Economy pricing + trade routes, AI mutation gates, Region sharding                                           | **0** (0 closed, 0 open)   | At least one extensibility hook emits telemetry; multiplayer party coordination prototype functional                                                    |
