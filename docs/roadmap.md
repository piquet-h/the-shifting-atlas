...
| 9     | #34   | Relative Direction Handling (N3)                                      |           | scope:traversal     | feature     | Todo   |
...
| 25    | #50   | AI Cost & Token Usage Telemetry + Budget Guardrails                   |           | scope:observability | feature     | Todo   |
...
| 28    | #22   | Automate implementation order assignment for new issues using Copilot |           | scope:devx          | enhancement | Done   |
| 29    | #26   | ✨ Set up Copilot instructions                                        |           | scope:devx          | enhancement | Done   |
| 30    | #21   | Remove text in logged in header                                       |           | scope:devx          | enhancement | Done   |
| 31    | #24   | "Create your explorer" fails                                          |           | scope:world         | bug         | Done   |
| 32    | #28   | Frontend Managed API not deploying properly                           |           | scope:devx          | bug         | Done   |
| 33    | #30   | Ensure correct Issue board status in Projects                         |           | scope:devx          | enhancement | Done   |
| 34    | #17   | DI Suitability Report                                                 |           | scope:devx          | docs        |        |
...
Last sync: 2025-09-30T00:00:00.000Z
