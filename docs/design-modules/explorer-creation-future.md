...
- **Player Identity Module**: `docs/design-modules/player-identity-and-roles.md` - Broader identity system including guilds, alignment, reputation
...
- **Player Interaction**: `docs/design-modules/player-interaction-and-intents.md` - How explorer skills affect command parsing
