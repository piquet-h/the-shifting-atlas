# Archived Full Version – ADR-001: Mosswell Persistence & Tokenless Description Layering

> This is the original accepted version (archived on 2025-10-02). A condensed, actively maintained summary lives at `../ADR-001-mosswell-persistence-layering.md`.
...
- Extend composer sequence (base → structural → ambient → enhancement → personalization) (terminology updated; legacy 'ordering' concept deprecated)
...
- `design-modules/navigation-and-traversal.md` (LOOK pipeline)
- `design-modules/ai-prompt-engineering.md` (generation integration)
