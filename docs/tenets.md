...
**Principle**: AI acts as the Dungeon Master voice. Deterministic code captures state for repeatable play; AI creates immersion and contextual decision-making.
...
**Tradeoff**: Bounded latency budgets for AI (with safe fallbacks). This is a text adventure: we’ll accept slightly higher latency for richer narrative when it is explicitly bounded and cached.

**Key Distinction**:

- ❌ Don't hard-code "move never triggers events" business rules
- ✅ Do let AI decide contextually (moving into villain's lair → alert NPC)
- ❌ Don't bypass AI layer for perceived "efficiency"
- ✅ Do capture AI classification decisions in telemetry for learning

**Related Tenets from Vision**:

- Prefer narrative humour & gameplay over accurate simulation
- Determinism over raw randomness (in state capture, not AI decisions)
- Advisory AI before mutation (M4 read-only, M7+ write path)
...
| ------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| Deterministic state capture; AI-driven immersion        | Enables repeatable play + recovery; AI contextual decisions          | Bounded AI latency budgets; fast fallback; rare bounded blocking only when caching the first-look hero prose |
...
_Last updated: 2025-11-24 (added AI-driven state/immersion distinction to Narrative Consistency tenet; adapted Microsoft Well-Architected Framework)_
