...
| ------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| Deterministic state capture; AI-driven immersion        | Enables repeatable play + recovery; AI contextual decisions          | Bounded AI latency budgets; fast fallback; rare bounded blocking only when caching the first-look hero prose (see [Hero Prose Blocking Policy](./architecture/hero-prose-blocking-policy.md)) |
