...
**Tradeoff**: Requires <500ms AI decision latency; fallback to simpler patterns if AI response too slow.
...
| ------------------------------------------------------- | -------------------------------------------------------------------- | --------------------------------------------- |
| Deterministic state capture; AI-driven immersion        | Enables repeatable play + recovery; AI contextual decisions          | <500ms AI latency budget; fallback patterns   |
