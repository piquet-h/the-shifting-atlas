...
These example flows are intentionally short; expand as needed in `docs/architecture/narration-governance.md` and `docs/design-modules/player-interaction-and-intents.md`.
