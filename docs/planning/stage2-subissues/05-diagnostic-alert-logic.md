...
_This alert was automatically generated by `.github/workflows/calculate-variance.yml`_
```
...
_Auto-closed by variance monitoring workflow_
```
...
```javascript
export { createOrUpdateAlert, closeAlert, checkEscalation, detectPatterns, findOpenAlert, getWeekKey }
```
