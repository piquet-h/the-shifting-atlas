...
Pending exits are **player-visible**. They are not hidden state. UI surfaces (command output, navigation affordances, and map views) SHOULD present pending directions as frontier links, clearly distinguished from hard edges.
