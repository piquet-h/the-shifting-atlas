...
import { getPlayerRepository } from '../src/repos/playerRepository.js'
import { getLocationRepository } from '../src/repos/locationRepository.js'
import { STARTER_LOCATION_ID } from '../src/location.js'
...
function stepLog(stepNumber: number, stepName: string, status: string, details: string = ''): void {
