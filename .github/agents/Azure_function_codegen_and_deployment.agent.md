---
name: Azure-Functions-Codegen-Deployment
description: Generate and deploy Azure Functions with comprehensive planning, code generation, and deployment automation.
target: vscode
argument-hint: '@Azure_function_codegen_and_deployment <plan|generate|test|deploy> <function-description>'
tools:
    [
        'changes',
        'edit',
...
handoffs:
    - label: Game Mechanics Validation
      agent: Atlas-Game-Logic-Agent
      prompt: For validating game mechanics implementation requirements
    - label: Documentation
      agent: Atlas-Documentation-Agent
      prompt: For documenting new Functions and deployment procedures
---
