...
- **Data:** Azure Cosmos DB (Gremlin API) – graph persistence for locations, NPCs, players, events.
...
- **Cosmos DB:**
    ...
    - Collections: `Locations`, `NPCs`, `Players`, `Events`.
...
- **Player actions**:
    ...
    - Fetch current location and state from Cosmos DB before applying changes.
