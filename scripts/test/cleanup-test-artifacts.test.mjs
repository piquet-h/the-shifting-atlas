...
const positives = ['test-loc-hub', 'e2e-test-loc-hub', 'e2e-abc123', 'test-player-xyz', 'demo-player-01']

const negatives = ['prod-loc-hub', 'player-regular-123', 'location-abc', '', null, undefined, 'random-id']
