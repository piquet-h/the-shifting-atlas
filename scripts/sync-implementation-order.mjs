...
async function fetchProjectItems() {
    ...
    for (const kind of attempts) {
        ...
        if (projectId) return { projectId, nodes: nodes.filter((n) => n.content && n.content.number), ownerType: kind }
