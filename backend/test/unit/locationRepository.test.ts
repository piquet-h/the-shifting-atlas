...
test('InMemoryLocationRepository - get returns location', async () => {
...
test('InMemoryLocationRepository - move with valid exit', async () => {
    const repo = new InMemoryLocationRepository()
...
test('InMemoryLocationRepository - move with invalid exit returns error', async () => {
    const repo = new InMemoryLocationRepository()
...
test('InMemoryLocationRepository - upsert creates new location', async () => {
    const repo = new InMemoryLocationRepository()
...
test('InMemoryLocationRepository - upsert existing location updates', async () => {
    const repo = new InMemoryLocationRepository()
...
test('CosmosLocationRepository - get returns location', async () => {
...
test('CosmosLocationRepository - upsert creates new location', async () => {
    const mockClient = new MockGremlinClient()
    const repo = new CosmosLocationRepository(mockClient as unknown as IGremlinClient)
...
test('CosmosLocationRepository - ensureExit creates exit idempotently', async () => {
    const mockClient = new MockGremlinClient()
    const repo = new CosmosLocationRepository(mockClient as unknown as IGremlinClient)
