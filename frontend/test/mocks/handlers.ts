        ...
        if (isStarter) {
            return HttpResponse.json({
                ...
                data: {
                    ...
                    description:
                        'Timbered jetty where river current meets brackish tide; a moss‑rimmed fountain anchors a plank‑lined plaza just inland.',
                    exits: [
        ...
        if (isNorthRoad) {
            return HttpResponse.json({
                ...
                data: {
                    id: locationId,
                    name: 'North Road',
                    description: 'Slight rise leading north; bustle of the square fades behind while the wooden gate looms ahead.',
                    exits: [
