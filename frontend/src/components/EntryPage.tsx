...
export default function EntryPageTailwind(): React.ReactElement {
    return (
        <main
            id="main"
            className="min-h-screen flex flex-col gap-4 p-5 text-slate-100 bg-gradient-to-b from-atlas-bg to-atlas-bg-dark"
            aria-labelledby="page-title"
        >
            <header className="flex items-center gap-3">
                <Logo />
                <div>
                    <h1 id="page-title" tabIndex={-1} className="text-xl font-semibold">
                        The Shifting Atlas
                    </h1>
            ...
            >
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                    <div>
                        ...
                        <p className="text-sm text-atlas-muted">
                            Explore. Trade. Survive. Shape the Atlas with other players.
                        </p>
                    </div>
