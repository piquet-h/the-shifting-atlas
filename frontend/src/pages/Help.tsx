        ...
        <div className="min-h-screen p-5 text-slate-100 bg-gradient-to-b from-atlas-bg to-atlas-bg-dark">
            ...
            <div className="mt-6 flex flex-col gap-4">
                ...
                <section className="p-4 rounded-lg bg-white/5 ring-1 ring-white/10">
                    ...
                    <ul className="list-disc list-inside text-sm text-slate-300 space-y-1">
                        <li>
                            <code className="bg-black/30 px-1 rounded">look</code> - Examine your current location
                        </li>
                        <li>
                            <code className="bg-black/30 px-1 rounded">north/south/east/west</code> - Move in a direction
                        </li>
                        <li>
                            <code className="bg-black/30 px-1 rounded">inventory</code> - View your items
                        </li>
                    </ul>
                </section>
                <section className="p-4 rounded-lg bg-white/5 ring-1 ring-white/10">
